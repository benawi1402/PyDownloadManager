...
class Config(BaseModel):
    ...
    def memory_limit_per_download_constrains(cls, v):
    ...
    def default_speed_limit_per_download_constrains(cls, v):
        if v < 1:
    ...
    def default_download_concurrent_limit_constrains(cls, v):
        if v < 1:
